...
# Q&A
insert into scrumgame.MultipleChoiceQuestion (Question_1, Question_2, Question_3, Question_4,choice_1,choice_2,choice_3,choice_4,Question_type) values ("What kind of software development projects can be executed by Scrum Project Management Framework?", "What does NOT belong to cornerstones of the agile manifesto?", "What is defined by the Scrum Framework?", "Where are the customer requirements stored?","Processes over people","Rules & Roles","In the Product Backlog","All kinds of software development projects","Beginner");
Insert into scrumgame.MultipleChoiceQuestion (Question_1, Question_2, Question_3, Question_4,choice_1,choice_2,choice_3,choice_4,Question_type)  values ("Which concept is NOT defined in the Scrum Framework?", "What is important in all Scrum projects?", "In software engineering what are the disadvantages of the classical waterfall model?", "What kind of software development projects can be executed by Scrum Project Management Framework?"," Self-organization, Continuous improvement","End-Product has to be fully anticipated beforehand.","Sub-systems, components or parts of bigger systems","Project Manager","Intermediate");
Insert into scrumgame.MultipleChoiceQuestion (Question_1, Question_2, Question_3, Question_4,choice_1,choice_2,choice_3,choice_4,Question_type) values ("How is scrum different from Iterative model?", "What do you think should be the ideal size of a Scrum team?", "How requirements are defined in a scrum?", "What are the advantages of the Scrum Framework?","The ideal size is 7 to9 with +/- 2","User Stories","Quick Turnaround, adaptation to design change","Scrum is a type of iterative model only but it is iterative + incremental.","Expert");
